...
public class Streaming extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //  = "http://es.pagez.kr:5sss4321";
        new GetClass(Streaming.this).execute();
    ...
    private class GetClass extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            try {
                ...
                url = String.format("http://%s:23457/", responseOutput.toString());
                Streaming.this.runOnUiThread(new Runnable() {
